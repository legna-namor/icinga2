...
public:
	 ...
	 *
	 * This tuple consists of the dependency parent Checkable, the dependency TimePeriod (nullptr if not configured),
	 * the state filter, and the ignore soft states flag.
	 */
...
protected:
	...
	static void RegisterRedundancyGroup(const DependencyGroup::Ptr& dependencyGroup);
